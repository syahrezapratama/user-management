<template>
  <div class="container mt-5" id="box-container">
    ...
    <div class="row d-flex justify-content-center" v-if="registrationDone">
      <div class="alert alert-success">
        <p>
          Vielen Dank für Ihre Anmeldung. Um Ihre Registrierung abzuschließen,
          klicken Sie bitte auf den Link in der E-Mail.
        </p>
      </div>
    </div>
    <div class="row d-flex justify-content-center" v-else>
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="row mb-3" :class="{ invalid: !password.isValid }">
          <label class="col-4 col-form-label" for="password">Passwort</label>
          <div class="col-8">
            <input
              class="form-control"
              id="password"
